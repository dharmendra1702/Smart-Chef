  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      chats.add(Content(role: 'user', parts: [
        Part.text(kChatbotPromt),
      ]));
      chats.add(Content(role: 'model', parts: [Part.text('Got it!')]));
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      child: const CookingLoadingAnimation(
                        size: 40,
                        showCaption: false,
                      ),
                    ),
                ...
                child: ChatInputBox(
                  ...
                  onSend: () {
                    if (controller.text.isNotEmpty) {
                      ...
                      chats.add(
                        Content(
                            role: 'user', parts: [Part.text(searchedText)]),
                      );
                      controller.clear();
                      loading = true;
                          ...
                          setState(
                            () {
                              if (chats.isNotEmpty &&
                                ...
                                final lastPart = chats.last.parts!.last;
                                if (lastPart is TextPart) {
                                  // Replace the last part with the updated streamed text
                                  chats.last.parts!.removeLast();
                                  chats.last.parts!.add(
                                    Part.text(
                                      '${lastPart.text}${value.output}',
                                    ),
                                  );
                                }
                              } else {
          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: Markdown(
                ...
                physics: const NeverScrollableScrollPhysics(),
                data: (content.parts?.lastOrNull is TextPart)
                    ? (content.parts?.lastOrNull as TextPart).text
