                          ...
                          setState(
                            () {
                              if (chats.isNotEmpty &&
                                ...
                                if (lastPart is Parts) {
                                  // Assuming Parts has a copyWith or similar method, or you can replace the last element
                                  chats.last.parts!.removeLast();
                                  chats.last.parts!.add(
                                    Parts(
                                      text: '${lastPart.text}${value.output}',
                                    ),
                                  );
                                }
                              } else {
          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: Markdown(
                ...
                physics: const NeverScrollableScrollPhysics(),
                data: (content.parts?.lastOrNull is Parts)
                    ? (content.parts?.lastOrNull as Parts).text ?? 'Something went wrong :('
